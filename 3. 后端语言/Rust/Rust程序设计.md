...
本书全面介绍了 Rust 为用户赋予的能力。其内容平易近人，致力于帮助你提升 Rust 的知识，并且提升你作为程序员整体的理解与自信。那么让我们准备深入学习 Rust 吧（打开新世界的大门 :)）
总的来说，rust拥有优异的内存管理能力，拥有高性能的同时更加安全，他通cpp一样足够底层，可以用来编写CLI，web server，web应用以及嵌入式。
